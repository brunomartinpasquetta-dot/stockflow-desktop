...
/* Columna del logo: el texto se ENCUADRA bajo el cubo y se ESTIRA hasta el
   final del cuadrado (pedido de Bruno, sep-2026): letra +1.5px y márgenes
   auto que reparten el alto sobrante (con padding de respaldo para móvil,
   donde la columna no se estira y el margin:auto colapsa a 0). */
.hero-left{{max-width:440px;align-self:stretch;display:flex;flex-direction:column;}}
.hero-left .trust{{margin-top:auto;padding-top:20px;font-size:15.5px;}}
.hero-left .hprice{{margin-top:auto;padding-top:14px;margin-bottom:4px;font-size:16px;}}
/* Bajo el título: botones apilados a la IZQUIERDA (ocupan el recuadro) y
   "Características principales" en PARALELO a la derecha. */
.hero-acciones{{display:flex;flex-direction:column;justify-content:center;gap:16px;margin-top:26px;align-self:stretch;}}
...
.hero-feats .feats li{{font-size:13.5px;padding:4.5px 0 4.5px 22px;}}
