...
/* Prueba social (versión ANÓNIMA definitiva — ver decisión en el BODY) */
...
<!-- DECISIÓN DEFINITIVA (Bruno, sep-2026): la prueba social va ANÓNIMA.
     Se decidió NO pedir permiso a los clientes para publicar sus nombres,
     así que los nombres reales NO VAN acá — no restaurarlos "porque quedaba
     mejor": es una decisión de privacidad, no un placeholder. Los datos
     descriptivos (rubro, localidad, CAE, terminales en red) son verdaderos. -->
<section class="sec social-sec" id="clientes"><div class="wrap">
 ...
 <div class="sp-cards rv">
  <div class="sp-card"><div class="sp-name">Un autoservicio de Coronda, Santa Fe</div><div class="sp-meta">Ventas, caja y cuentas corrientes registradas todos los días</div></div>
  <div class="sp-card"><div class="sp-name">Una imprenta con varias terminales en red</div><div class="sp-meta">Factura electrónica con CAE desde StockFlow</div></div>
 </div>
 <p class="sp-foot">Si querés hablar con un cliente real antes de decidir, te paso el contacto.</p>
</div></section>
