...
/* El logo llena el ancho de su sección (grande, como en la captura de referencia). */
.hero-cube{{width:100%;max-width:420px;height:auto;display:block;margin:8px 0 10px;filter:drop-shadow(0 22px 38px rgba(43,111,214,.30));image-rendering:auto;}}
@media(max-width:960px){{.hero-cube{{max-width:300px;}}}}
...
.cfrow{{position:relative;height:560px;margin-top:14px;}}
...
.cf-card{{position:absolute;top:50%;left:50%;width:min(90%,700px);margin:0;
