...
.proof .pmark{{display:inline-flex;align-items:center;gap:6px;color:#fff;font-weight:700;white-space:nowrap;vertical-align:-3px;}}
.proof .pmark svg{{width:17px;height:17px;flex:none;}}
...
<!-- ARCA va como wordmark tipográfico: no hay SVG oficial confiable del logo
     y un logo dibujado a mano de un organismo público quedaría trucho. -->
<section class="proof"><div class="wrap">
 <span><span class="pdot"></span>En producción desde 2022: integración con <span class="pmark">{MP_SVG}Mercado Pago</span> · <b>ARCA</b> · <span class="pmark">{WA_SVG}WhatsApp</span> y <b>tu catálogo web</b>. <b>Todo en un mismo lugar</b> — asistente virtual incorporado y soporte directo de quien lo desarrolla.</span>
</div></section>
