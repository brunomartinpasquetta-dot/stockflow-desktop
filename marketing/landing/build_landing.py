...
.proof-logos{{flex-basis:100%;display:flex;gap:34px;align-items:center;justify-content:center;flex-wrap:wrap;margin-top:12px;}}
.proof-logos svg{{width:24px;height:24px;color:#fff;display:block;}}
.proof-logos img{{height:20px;width:auto;display:block;}}
...
<section class="proof"><div class="wrap">
 ...
 <div class="proof-logos">
  <span class="plg-mp" title="Mercado Pago">{MP_SVG}</span>
  <span class="plg-wa" title="WhatsApp">{WA_SVG}</span>
  <img src="{L_ARCA}" {wh(L_ARCA)} alt="ARCA" loading="lazy"/>
  <img src="{L_BNA}" {wh(L_BNA)} alt="Banco de la Nación Argentina" loading="lazy"/>
  <img src="{L_UALA}" {wh(L_UALA)} alt="Ualá" loading="lazy"/>
 </div>
</div></section>
