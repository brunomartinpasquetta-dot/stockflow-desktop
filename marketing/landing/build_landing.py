...
L_ARCA=img('logo-arca.png', maxw=440, q=85); L_BNA=img('logo-bna.png', maxw=130, q=85); L_UALA=img('logo-uala.png', maxw=150, q=85)
...
.hero-logos{{display:flex;gap:24px;align-items:center;justify-content:center;flex-wrap:wrap;margin-top:16px;}}
.hero-logos svg{{width:26px;height:26px;display:block;}}
.hero-logos .hl-mp{{color:#009ee3;}} .hero-logos .hl-wa{{color:var(--wa);}}
.hero-logos img{{height:22px;width:auto;display:block;}}
...
<header class="hero" id="top"><div class="wrap">
 ...
 <div class="hero-acciones">
  ...
  <div class="hero-logos">
   <span title="Mercado Pago" class="hl-mp">{MP_SVG}</span>
