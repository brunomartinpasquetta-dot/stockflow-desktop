...
const GROUPS: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { pageKey: 'caja-general', label: 'Caja General', icon: Banknote, shortcut: 'F8', requires: 'view_cash_general' },
      { separator: true, label: '' },
      { pageKey: 'auditoria', label: 'Auditoría', icon: ScrollText, roles: ['admin'] },
    ],
  },
  {
    name: 'Contabilidad',
