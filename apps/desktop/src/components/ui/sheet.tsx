...
>(({ className, children, side = 'right', ...props }, ref) => (
  <SheetPrimitive.Portal>
    ...
    >
      {children}
      <SheetPrimitive.Close title="Cerrar" className="absolute right-4 top-4 rounded-sm opacity-60 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring">
        <X className="h-4 w-4" />
