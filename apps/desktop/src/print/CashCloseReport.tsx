  ...
  return (
    <div className="print-a4">
      ...
      <div className="mb-4 max-w-md text-sm">
        ...
        <Row label={`Ingresos en efectivo (${report.incomeCount})`} value={formatCurrency(report.incomeTotal)} />
        <Row label={`Egresos en efectivo (${report.expenseCount})`} value={formatCurrency(report.expenseTotal)} />
        <Row label="Efectivo esperado" value={formatCurrency(report.expectedCash)} strong />
